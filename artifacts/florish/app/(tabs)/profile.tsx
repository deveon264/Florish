          ...
          <View style={[styles.sheet, { backgroundColor: colors.card }]}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.sheetScroll}>
              {[
                ...
                { q: "Can I add my own workout videos?", a: "Workout demo videos are uploaded by Dillish exclusively. Open any workout, and the Upload Demo Video button will appear on each exercise when signed in as the Florish account." },
